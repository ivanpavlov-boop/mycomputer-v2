...
return new class extends Migration
{
    public function up(): void
    {
        ...
        CanonicalSupplierPhaseThreeP0Schema::runForwardStep(P0MigrationStep::P0_02);
    }
    ...
    public function down(): void
    {
        ...
        CanonicalSupplierPhaseThreeP0Schema::runTerminalDowngradeStep(P0MigrationStep::P0_02);
    }
};
