...
class ApcomSupplierIntegrationSeeder extends Seeder
{
    public function run(): void
    {
        ...
        SupplierFeed::query()->updateOrCreate(
            ...
            [
                'feed_type' => 'xml',
                'feed_url' => config('services.suppliers.apcom.feed_url'),
                'username' => null,
                'password' => null,
                'update_interval' => '12h',
                'mapping' => [
                    'product_node' => 'xml.product',
                    'supplier_sku' => ['partno', 'SKU', 'Code', 'ItemCode', 'ProductCode', '@sku'],
                    'ean' => ['ean', 'EAN', 'Barcode', 'GTIN'],
                    'mpn' => ['partno', 'MPN', 'VendorCode', 'ManufacturerCode', 'PartNumber'],
                    'name' => ['name', 'Name', 'ProductName', 'Title'],
                    'brand' => ['manufacturer', 'Brand', 'Manufacturer', 'Vendor'],
                    'category' => ['category', 'CategoryPath', 'Category', 'ProductCategory'],
                    'price' => ['fd_price', 'dac_price', 'Price', 'DealerPrice', 'EndUserPrice'],
                    'quantity' => ['stock', 'Stock', 'Quantity', 'Qty'],
                    'availability' => ['Availability', 'AvailabilityStatus', 'StockStatus'],
                    'image' => ['images.image', 'Image', 'ImageURL', 'Picture', 'Images/Image'],
                ],
                'status' => 'active',
            ],
        );
        ...
        XmlMappingTemplate::query()->updateOrCreate(
            ...
            [
                ...
                'field_map' => [
                    ...
                    'mpn' => ['partno', 'MPN', 'VendorCode', 'ManufacturerCode', 'PartNumber'],
                    'name' => ['name', 'Name', 'ProductName', 'Title'],
                    'brand_name' => ['manufacturer', 'Brand', 'Manufacturer', 'Vendor'],
                    'category_name' => ['category', 'CategoryPath', 'Category', 'ProductCategory'],
                    'price' => ['fd_price', 'dac_price', 'Price', 'DealerPrice', 'EndUserPrice'],
                    'quantity' => ['stock', 'Stock', 'Quantity', 'Qty'],
                    'external_availability_status' => ['Availability', 'AvailabilityStatus', 'StockStatus'],
                    'external_availability_label' => ['eol', 'AvailabilityLabel', 'DeliveryTime'],
                    'currency' => ['Currency'],
                    'image_url' => ['images.image', 'Image', 'ImageURL', 'Picture', 'Images/Image'],
                ],
                'validation_rules' => [
