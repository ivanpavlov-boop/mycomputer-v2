...
class MarketingStats extends StatsOverviewWidget
{
    protected function getStats(): array
    {
        ...
        return [
            Stat::make('Total revenue', number_format((float) Order::query()->sum('grand_total'), 2).' BGN'),
            ...
            Stat::make('Recovered revenue', number_format((float) AbandonedCartRecord::query()->sum('recovered_revenue'), 2).' BGN'),
            ...
            Stat::make('Promotion discounts', number_format((float) PromotionRedemption::query()->sum('discount_amount'), 2).' BGN'),
            Stat::make('Active bundles', ProductBundle::query()->available()->count()),
            Stat::make('Bundle revenue', number_format((float) OrderBundleItem::query()->sum('total_price'), 2).' BGN'),
