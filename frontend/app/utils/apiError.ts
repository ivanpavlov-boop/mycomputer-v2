...
const SAFE_ERROR_MESSAGES: Record<string, string> = {
  ...
  checkout_idempotency_key_invalid: 'Неуспешно започване на поръчката. Опитайте отново.',
  checkout_idempotency_conflict: 'Опитът за поръчка вече е използван с различни данни.',
  checkout_already_completed: 'Тази количка вече е превърната в поръчка.',
