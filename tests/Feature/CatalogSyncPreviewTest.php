...
class CatalogSyncPreviewTest extends TestCase
{
    ...
    public function test_catalog_sync_preview_update_diff_preview_shows_commercial_changes_without_writes(): void
    {
        ...
        $preview
            ...
            ->assertSee('Price:')
            ->assertSee('50.00 EUR -> 120.00 EUR (+70.00 EUR)')
            ->assertSee('Supplier cost:')
            ->assertSee('40.00 EUR -> 100.00 EUR')
            ->assertSee('Selected offer:')
            ->assertSee('Supplier Product #'.$supplierProduct->id.' / DIFF-PREVIEW-UPDATE')
